...
namespace F23Bag.Tests
{
    ...
    public class QueryTests
    {
        ...
        private class PropertyMapper : IPropertyMapper
        {
            ...
            public void DeclareMap(Request request, PropertyInfo property, AliasDefinition alias, bool isNewElement)
            {
                request.Select.Add(new SelectInfo(new ColumnAccess(alias, new Identifier("NameCustomMapper")), property, false));
            }
